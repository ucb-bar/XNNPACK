...
load("gemmini_microkernels.bzl", _ALL_GEMMINI_MICROKERNEL_SRCS = "ALL_GEMMINI_MICROKERNEL_SRCS", _NON_PROD_GEMMINI_MICROKERNEL_SRCS = "NON_PROD_GEMMINI_MICROKERNEL_SRCS", _PROD_GEMMINI_MICROKERNEL_SRCS = "PROD_GEMMINI_MICROKERNEL_SRCS")
...
ALL_GEMMINI_MICROKERNEL_SRCS = _ALL_GEMMINI_MICROKERNEL_SRCS
...
NON_PROD_GEMMINI_MICROKERNEL_SRCS = _NON_PROD_GEMMINI_MICROKERNEL_SRCS
...
PROD_GEMMINI_MICROKERNEL_SRCS = _PROD_GEMMINI_MICROKERNEL_SRCS
...
PROD_C_SRCS_FOR_ARCH = {
    ...
    "gemmini": PROD_GEMMINI_MICROKERNEL_SRCS,
...
NON_PROD_C_SRCS_FOR_ARCH = {
    ...
    "gemmini": NON_PROD_GEMMINI_MICROKERNEL_SRCS,
